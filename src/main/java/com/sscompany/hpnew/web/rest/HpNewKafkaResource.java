...
@RestController
@RequestMapping("/api/hp-new-kafka")
public class HpNewKafkaResource {
    private final Logger log = LoggerFactory.getLogger(HpNewKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HpNewKafkaResource(KafkaProperties kafkaProperties) {
